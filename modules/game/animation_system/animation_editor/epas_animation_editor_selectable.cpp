...
EPASAnimationEditorBoneSelectable::EPASAnimationEditorBoneSelectable(Ref<EPASAnimationEditorDocument> p_document, Ref<EPASAnimationEditorIKJoint> p_ik_joint, int p_bone_idx) : EPASAnimationEditorSelection(p_document) {
    ik_joint = p_ik_joint;
    bone_idx = p_bone_idx;
}
...
EPASAnimationEditorWarpPointSelectable::EPASAnimationEditorWarpPointSelectable(Ref<EPASWarpPoint> p_warp_point, Ref<EPASAnimationEditorDocument> p_document) : EPASAnimationEditorSelection(p_document) {
...
EPASAnimationEditorDirectionalEventSelection::EPASAnimationEditorDirectionalEventSelection(Ref<EPASAnimationEditorDocument> p_document, Ref<EPASDirectionalAnimationEvent> p_event) : EPASAnimationEditorSelection(p_document) {
