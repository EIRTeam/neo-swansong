...
from common import get_source_files, ExtractType, Message
...
if not os.path.exists("agent_constants.cpp"):
    sys.exit("ERROR: This script should be started from the root of the Swansong module.")

main_po = """
# LANGUAGE translation of Swansong
# Copyright (c) 2024-present EIRTeam
# This file is distributed under the same license as the Swansong source code.
#
...
msgid ""
msgstr ""
"Project-Id-Version: Swansong interface\\n"
"MIME-Version: 1.0\\n"
...
print("Updating the swansong.pot template...")
...
with open("swansong.pot", "w") as f:
    f.write(main_po)

if os.name == "posix":
    print("Wrapping template at 80 characters for compatibility with Weblate.")
    os.system("msgmerge -w80 swansong.pot swansong.pot > swansong.pot.wrap")
    shutil.move("swansong.pot.wrap", "swansong.pot")

shutil.move("swansong.pot", "locale/swansong.pot")
